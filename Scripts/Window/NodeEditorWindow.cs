...
namespace NodeTreeEditor.Window {
	...
	public class NodeEditorWindow : EditorWindow {
		...
		void EditorDraw () {
			...
			GUI.Box (new Rect(0, 40, windowSize.width, 660), "");
			scrollView = GUI.BeginScrollView (new Rect(0, 40, windowSize.width, 660), scrollView, nodeEditorSize);
			{
				var ev = Event.current;
				menu = new GenericMenu ();
				if (ev.type == EventType.ContextClick) {// TODO type add
		...
		void RegisterMenuAll (Vector2 pos) {
